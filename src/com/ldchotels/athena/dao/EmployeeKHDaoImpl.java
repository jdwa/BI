...
public class EmployeeKHDaoImpl extends HibernateDaoSupport implements EmployeeDao {
	...
	private static Logger logger = Logger.getLogger(EmployeeKHDaoImpl.class.getName());
		
	@Override
	@SuppressWarnings("unchecked")
	@Transactional(readOnly = true)
	public Employee findById_nos(String id_nos) {
		List<Employee> employeeList = (List<Employee>) getHibernateTemplate().find("from EmployeeKH where id_nos = '" + id_nos + "'");
	...
	public List<Employee> list() {	
		...
		logger.info("EmployeeKHDaoImpl:list");
		return getHibernateTemplate().find("from EmployeeKH");
	}
